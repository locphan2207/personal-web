...
const animateToPage2 = () => {
  ...
  p1.animate({ d: po2, transform: t2 }, 3000, window.mina.easeinout)
  const svg1 = Snap.select("#top-left-bubble")
  svg1.animate({ width: 900 }, 3000, window.mina.easeinout)
}

const animateToPage1 = () => {
  const p1 = Snap.select("#top-left-svg")
  const po1 =
  ...
  p1.animate({ d: po1, transform: t1 }, 3000, window.mina.easeinout)
  const svg1 = Snap.select("#top-left-bubble")
  svg1.animate({ width: 700 }, 3000, window.mina.easeinout)
}
...
function App() {
  ...
  return (
    <div className="App">
      <NavBar onWorkOpen={onWorkOpen} onHomeOpen={onHomeOpen} />
